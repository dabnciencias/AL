...
%    \underline{Def.} Sean $(A,\star)$ y $(B,\diamondsuit)$ estructuras algebráicas tales que los contradominios de $\star$ y $\diamondsuit$ son $A$ y $B$, respectivamente. Decimos que una función $f:A\to B$ es \emph{compatible con las operaciones} $\star$ \emph{y} $\diamondsuit$ si, para todo $x,y\in A$, se cumple que
%    \[
