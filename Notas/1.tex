...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[thick,scale=1.6, every node/.style={scale=1}]
        ...
        \foreach \y in {1,2,3,4}
            ...
            \draw[MAGENTA,very thick,->] (0,0) -- (3,4) node[] at (3,4.2) {$(3,4)$};
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \draw[MAGENTA,very thick,->] (0,0) -- (4,4) node[anchor=south west] {$\begin{pmatrix} 4 + 4i \end{pmatrix}$};
    \end{tikzpicture}
