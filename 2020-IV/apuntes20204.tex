...
\textbf{Notación de bra-ket (o de Dirac):}
\begin{tcolorbox}
    \centering
    \begin{tabular}{cc}
        \\
...
\noindent Una observación muy importante es que en esta nueva notación, por razones que veremos más adelante, la entrada derecha del producto escalar será lineal, mientras que la entrada izquierda será antilineal. Es decir, que si $\ket{u},\ket{v}\in V$ y $\alpha\in K$, donde $(V,K)$ es un espacio vectorial, entonces en general \[
\bra{u}\big (\ket{\alpha v}\big ) = \alpha\braket{u|v}
\] \noindent y \[
\big (\bra{\alpha u}\big ) \ket{v} = \overline{\alpha}\braket{u|v}.
\]  
